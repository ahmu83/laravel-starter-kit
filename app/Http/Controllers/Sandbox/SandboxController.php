...
class SandboxController extends Controller
{
  ...
  public function index(Request $request)
  {
    $data = [
      ...
      'routes'      => [
        'ping'             => url('sandbox/ping'),
        'test'             => url('sandbox/test'),
        'test_proxied_url' => url('sandbox/test/proxied-url'),
      ],
    ];
  ...
  public function pages(Request $request) {
    $links = [
      'Logs Viewer'   => url('toolbox/log-viewer'),
      'Queues Viewer' => url('toolbox/queues'),
      'Tinker'        => url('toolbox/tinker'),
      'Pulse APM'     => url('toolbox/pulse'),
    ];
  ...
  public function proxiedUrl(Request $request)
  {
    dd([
